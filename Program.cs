...
builder.Services.AddScoped<IModeloDocumentoServico, ModeloDocumentoServico>();
...
modelBuilder.EntitySet<ModeloDocumento>("ModelosDocumento");
modelBuilder.EntitySet<SecaoModelo>("SecoesModelo");
...
if (app.Environment.IsDevelopment())
{
    ...
    // Garantir que coluna Nativo existe (pode ter ficado faltando entre migrations)
    try { await db.Database.ExecuteSqlRawAsync("ALTER TABLE \"Campo\" ADD COLUMN IF NOT EXISTS \"Nativo\" boolean NOT NULL DEFAULT false"); } catch { }

    // Garantir que tabelas ModeloDocumento e SecaoModelo existem
    try { await db.Database.ExecuteSqlRawAsync(@"
        CREATE TABLE IF NOT EXISTS ""ModeloDocumento"" (
            ""Id"" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ""Nome"" varchar(300) NOT NULL,
            ""Descricao"" varchar(1000),
            ""EntidadeAlvo"" text NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS ""SecaoModelo"" (
            ""Id"" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ""Nome"" varchar(200) NOT NULL,
            ""Ordem"" integer NOT NULL DEFAULT 0,
            ""ConteudoHtml"" text NOT NULL DEFAULT '',
            ""ModeloDocumentoId"" bigint NOT NULL REFERENCES ""ModeloDocumento""(""Id"") ON DELETE CASCADE,
            ""EmpresaId"" bigint NOT NULL,
            ""CriadoEm"" timestamptz NOT NULL DEFAULT NOW(),
            ""AtualizadoEm"" timestamptz,
            ""Ativo"" boolean NOT NULL DEFAULT true,
